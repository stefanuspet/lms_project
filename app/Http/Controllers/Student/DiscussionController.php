...
class DiscussionController extends Controller
{
    public function index(Subject $subject)
    {
        ...
        return Inertia::render('Student/Discussion/Index', [
            'subject' => [
                'id' => $subject->id,
                'name' => $subject->name,
            ],
    ...
    public function store(Request $request, Subject $subject)
    {
        ...
        return redirect()
            ->route('student.discussions.index', $subject->id)
    ...
    public function show(Subject $subject, DiscussionThread $thread)
    {
        ...
        return Inertia::render('Student/Discussion/Show', [
            'subject' => [
                'id' => $subject->id,
                'name' => $subject->name,
            ],
    ...
    public function reply(Request $request, Subject $subject, DiscussionThread $thread)
    {
        ...
        return redirect()
            ->route('student.discussions.show', [$subject->id, $thread->id])
