...
const ExtracurricularCreate = ({ teachers, semesters }) => {
    ...
    return (
        <AuthenticatedLayout title="Tambah Ekstrakurikuler">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Tuliskan penjelasan singkat mengenai kegiatan ekstrakurikuler..."
                                    ></textarea>
                                    <InputError
...
export default ExtracurricularCreate;
