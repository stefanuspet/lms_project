...
const ExtracurricularIndex = ({
    ...
    const goToPage = (page) => {
        ...
        router.get(
            ...
            },
            {
                preserveState: true,
                preserveScroll: true,
                only: ["extracurriculars", "pagination", "filters"],
            }
        );
    };
    ...
    const handleDelete = (id) => {
        if (
            !confirm("Apakah Anda yakin ingin menghapus ekstrakurikuler ini?")
        ) {
            return;
        }
        ...
        router.delete(route("admin.extracurriculars.destroy", id), {
            preserveScroll: true,
    ...
    return (
        <AuthenticatedLayout title="Ekstrakurikuler">
            {flash?.success && (
            ...
            <div className="w-full py-6">
                <div className="w-full bg-white rounded-xl shadow-sm">
                    <div className="flex justify-between items-center px-6 py-5 border-b">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                                Lihat dan kelola kegiatan ekstrakurikuler
                                beserta jadwal dan pembinanya.
                            </p>
                        </div>
                        <div className="flex gap-3">
                            ...
                            <div className="flex items-center space-x-2">
                                <button className="p-2 rounded-full bg-[#FAE27C] text-amber-600 hover:bg-amber-200 transition-colors">
                                    <Setting4 color="black" size="24" />
                                </button>
                                <a
                                    href={route(
                                        "admin.extracurriculars.export"
                                    )}
                    ...
                    {/* Toolbar bawah: placeholder filter + export + tambah */}
                    ...
                    {pagination && pagination.total > 0 && (
                        <div className="px-6 py-4 flex items-center justify-between border-t border-gray-200">
                            ...
                            <button
                                onClick={() => goToPage(currentPage + 1)}
                                className="relative inline-flex items-mer-centers px-4 py-2 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
