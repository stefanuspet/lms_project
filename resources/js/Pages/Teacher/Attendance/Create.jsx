...
const AttendanceCreate = ({ semesters }) => {
    ...
    return (
        <TeacherLayout title="Buat Sesi Presensi">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2 bg-blue-50 p-4 rounded-lg mt-2">
                                    ...
                                    <p className="text-sm text-blue-600">
                                        Sistem ini akan membuat QR unik yang
                                        dapat dipindai oleh siswa melalui
                                        aplikasi mobile untuk menandai
                                        kehadiran. QR aktif selama durasi yang
                                        ditentukan. Bagikan QR atau token kepada
                                        siswa melalui pengumuman/WhatsApp atau
                                        tampilkan di layar kelas. Cocok untuk
                                        kegiatan sekolah seperti upacara,
